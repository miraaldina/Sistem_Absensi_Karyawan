...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    ...
    <!-- Main CSS-->
    <link href="css/data_absen.css" rel="stylesheet" media="all">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="datakaryawan.php">
                                <i class="fas fa-user-cog"></i>Data Karyawan</a>
                        </li>
                        <li>
                            <a href="datauser.php">
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    if ($jam_absen >= $awal && $jam_absen <= $terlambat) {
                                                        ...
                                                        $status = "<span class='badge badge-danger'>Diluar Jam Kerja</span>";
                                                    }
                                                ?>
                                                ...
                                                if (!empty($row['latitude']) && !empty($row['longitude'])) {
                                                    echo "<a href='https://www.google.com/maps?q={$row['latitude']},{$row['longitude']}' target='_blank' class='btn btn-info btn-sm'>Lihat Lokasi</a>";
                                                } else {
