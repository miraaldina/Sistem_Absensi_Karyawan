...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    ...
    <!-- Main CSS-->
    <link href="css/datakaryawan.css" rel="stylesheet" media="all">
                        ...
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning table-form-custom" >
                                        ...
                                        <tbody>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <button type="submit" name="simpan" class="btn btn-primary btn-form">Simpan</button>
                                                <button type="reset" class="btn btn-danger btn-form">Batal</button>
                                                </div>
                                            </td>
                                            </tr>
